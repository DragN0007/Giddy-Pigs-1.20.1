...
public class GuineaPigFollowOwnerGoal extends Goal {
   public final GuineaPig tamable;
   ...
   public GuineaPigFollowOwnerGoal(GuineaPig p_25294_, double v, float p_25296_, float p_25297_, boolean p_25298_) {
